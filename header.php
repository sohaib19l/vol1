        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            if(isset($_SESSION['userId'])) {
                ...
                <div class="dropdown-menu w-75" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item " href="' . (strpos($_SERVER["PHP_SELF"], "/views/") !== false ? "login.php" : "views/login.php") . '">Passenger</a>
                    <a class="dropdown-item " href="' . (strpos($_SERVER["PHP_SELF"], "/views/") !== false ? "../admin/login.php" : "admin/login.php") . '">Administrator</a>
                </div>
                </div>';
            }
            ?>
